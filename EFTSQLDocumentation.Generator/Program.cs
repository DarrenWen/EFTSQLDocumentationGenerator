...
namespace EFTSQLDocumentation.Generator
{
    ...
    class Program : IDisposable
    {
        ...
        private void CreateDocumentation()
        {
            ...
            IEnumerable<XElement> entityTypeElements = doc.Descendants("{http://schemas.microsoft.com/ado/2009/11/edm}EntityType");

            int i = 0;
            foreach (XElement entityTypeElement in entityTypeElements)
            {
                String tableName = entityTypeElement.Attribute("Name").Value;
                IEnumerable<XElement> propertyElements = entityTypeElement.Descendants("{http://schemas.microsoft.com/ado/2009/11/edm}Property");
        ...
        private void AddNodeDocumentation(XElement element, String documentation)
        {
            ...
            element.AddFirst(new XElement("{http://schemas.microsoft.com/ado/2009/11/edm}Documentation", new XElement("{http://schemas.microsoft.com/ado/2009/11/edm}Summary", documentation)));
        }
